...
export default function Colophon() {
  return (
    ...
    <p><em>The carbon footprint for this website is 0,10 gram of CO2 per page view.</em></p>
    <p className={utils.small}>Last checked on September 8th, 2025 by <a href="https://www.websitecarbon.com/website/astridmathilde-no/" target="_blank" rel="external noreferrer">websitecarbon.com</a></p>
    
    <h3>AI usage <BlockIcon>🤖</BlockIcon></h3>
    <p>I have not used generative AI for any of the content on this website. Not only because I prefer to use my own brain and creativity, but also because Large Language Models (LLMs) are associated with high energy consumption and water usage.</p>
