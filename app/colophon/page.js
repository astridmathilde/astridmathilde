...
export default function Colophon() {
  return (
    <>
    <h2 className={utils.screen_reader_text}>Colophon</h2>
    ...
    <p className={utils.small}>Last checked on February 9th, 2026 by <a href="https://www.websitecarbon.com/website/astridmathilde-no/" target="_blank" rel="external noreferrer">websitecarbon.com</a>.<br />
