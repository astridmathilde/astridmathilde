...
export default function Index() {
  return (
    ...
    <p>Just started my fourth year at the <a href="https://aho.no/en" target="_blank" rel="external">Oslo School of Architecture and Design</a> – it is weird how fast time flies. Also, I switched to a dumb phone (Punkt MP01) and it is going well so far. Found a old digital camera too, so that I can continue posting photos in my <a href="https://blikk.directory" target="_blank" rel="external">blikkjournal</a>. My personal projects have been neglected this summer due to an internship and a freelance project, so I am looking forward to continue working on my own things while getting back into my routines.</p>
