...
export default function Index() {
  return (
    ...
    <p>Heia! I am a designer and developer from Northern Norway, <Link href="now" title="my current status">currently doing</Link> a master’s in interaction design in Oslo. With a background in graphic design, web design and development, I now specialise in designing digital products. I also enjoy <Link href="notes" rel="my notes">writing things</Link>, <a href="https://blikk.directory" rel="external" title="my library of observations" target="_blank">taking photos of stuff</a>, and I have an interest for digital minimalism and <Link href="colophon" title="this site's climate footprint">web sustainability</Link>.</p>
