...
export default async function Index() {
  ...
  return (
    ...
    <p className={utils.small + " color-subtle"}>Last updated on December 18th, 2025. Inspired by <a href="https://nownownow.com/about" target="_blank" rel="external">Now</a>.</p>
